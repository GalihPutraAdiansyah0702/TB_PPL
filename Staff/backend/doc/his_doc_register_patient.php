                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Isi Semua Detail</h4>
                                        <!--Add Patient Form-->
                                        <form method="post">
                                            <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label">No.Tlp</label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputState" class="col-form-label">Jenis Perawatan</label>
                                            ...
                                            <button type="submit" name="add_patient" class="ladda-button btn btn-primary" data-style="expand-right">Daftar Pasien</button>
